...
void ade_convert(){
    ...
    ade_f.awatt = ((ade_raw.awatt_h << 16) + ade_raw.awatt_l) / PWR_CONST;
    ade_f.bwatt = ((ade_raw.bwatt_h << 16) + ade_raw.bwatt_l) / PWR_CONST;
    ade_f.cwatt = ((ade_raw.cwatt_h << 16) + ade_raw.cwatt_l) / PWR_CONST;
    ade_f.afwatt = ((ade_raw.afwatt_h << 16) + ade_raw.afwatt_l) / PWR_CONST;
    ade_f.bfwatt = ((ade_raw.bfwatt_h << 16) + ade_raw.bfwatt_l) / PWR_CONST;
    ade_f.cfwatt = ((ade_raw.cfwatt_h << 16) + ade_raw.cfwatt_l) / PWR_CONST;
    ade_f.ava = ((ade_raw.ava_h << 16) + ade_raw.ava_l) / PWR_CONST;
    ade_f.bva = ((ade_raw.bva_h << 16) + ade_raw.bva_l) / PWR_CONST;
    ade_f.cva = ((ade_raw.cva_h << 16) + ade_raw.cva_l) / PWR_CONST;
    ade_f.afva = ((ade_raw.afva_h << 16) + ade_raw.afva_l) / PWR_CONST;
    ade_f.bfva = ((ade_raw.bfva_h << 16) + ade_raw.bfva_l) / PWR_CONST;
    ade_f.cfva = ((ade_raw.cfva_h << 16) + ade_raw.cfva_l) / PWR_CONST;
    ade_f.avar = ((ade_raw.avar_h << 16) + ade_raw.avar_l) / PWR_CONST;
    ade_f.bvar = ((ade_raw.bvar_h << 16) + ade_raw.bvar_l) / PWR_CONST;
    ade_f.cvar = ((ade_raw.cvar_h << 16) + ade_raw.cvar_l) / PWR_CONST;
    ade_f.afvar = ((ade_raw.afvar_h << 16) + ade_raw.afvar_l) / PWR_CONST;
    ade_f.bfvar = ((ade_raw.bfvar_h << 16) + ade_raw.bfvar_l) / PWR_CONST;
    ade_f.cfvar = ((ade_raw.cfvar_h << 16) + ade_raw.cfvar_l) / PWR_CONST;
